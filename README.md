...
This is a test that we create to recruitment process of frontend junior developer.
...
3. You have **2 days** to send this test. 

## Tasks 👩‍💻👨‍💻

The milestone is seen how you're programming a UI built with `TailwindCSS` + `React` + `Rest API`.


1. Open the UI Design is in the `/assets` folder.
...
The Tailwind version is `2.2.19`, so read the [latest documentation](https://tailwindcss.com/).
...
Send in a maximum of 2 days, if you exceed this deadline, you will not be selected, but you may receive a feedback of your code. **Be responsible**.
